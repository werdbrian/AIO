// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpellLibrary.cs" company="LeagueSharp">
...
namespace AIO.Library
{
    ...
    ///     Updated 20/03/2015 - 5.5
    ///     Updated 29/03/2015 - 5.6
    ///     Updated 05/09/2015 - 5.17 (Hotfix)
    /// </summary>
    public static class SpellLibrary
    {
        ...
        /// <summary>
        ///     Initializes static members of the <see cref="SpellLibrary" /> class.
        /// </summary>
        static SpellLibrary()
        {
        ...
        /// <summary>
        ///     The get by missile name.
        /// </summary>
        /// <param name="missileSpellName">
        ///     The missile spell name.
        /// </param>
        /// <returns>
        /// </returns>
        ...
        /// <returns>
        /// </returns>
        public static SpellData GetSpell(string ChampionName, SpellSlot Slot)
        {
            foreach (var data in Spells)
            {
                if (data.ChampionName.ToLower() == ChampionName.ToLower() && data.Slot == Slot)
                {
                    return data;
                }
            }
        ...
        public class SpellData
        {
            ...
            /// <summary>
            ///     The disable fow detection.
            /// </summary>
            public bool DisableFowDetection = false;

            /// <summary>
            ///     The dont add extra duration.
            /// </summary>
            ...
            /// <summary>
            ///     The missile follows unit.
            /// </summary>
            public bool MissileFollowsUnit;

            /// <summary>
            ///     The missile max speed.
            /// </summary>
            public int MissileMaxSpeed;

            /// <summary>
            ///     The missile min speed.
            /// </summary>
            ...
            public int Radius
            {
                get
                {
                    return (!this.AddHitbox) ? this._radius : this._radius + (int)ObjectManager.Player.BoundingRadius;
                }
